...
**Author.** Nikolaos Lavidas, Associate Professor of Linguistics, National and Kapodistrian University of Athens (EKPA), Department of English Language and Literature, Section of Linguistics. ORCID: [ORCID pending]. Email: nlavidas@enl.uoa.gr.
...
**Dataset DOI.** [DOI pending Zenodo mint] (concept DOI).
...
| **Repository** | Zenodo (DOI [DOI pending Zenodo mint]); GitHub `AthDGC/Diachronic-Linguistics-Platform`; Hugging Face `athdgc/diachronic-greek-corpus` |
...
|---|---|---|
| Archaic | 8th-6th c. BC | (provisional) |
| Classical | 5th-4th c. BC | (provisional) |
| Koine | 3rd c. BC - 4th c. AD | (provisional) |
| Late Antique | 4th-7th c. AD | (provisional) |
| Byzantine | 7th-12th c. AD | (provisional) |
| Late Byzantine | 13th-15th c. AD | (provisional) |
| Early Modern | 16th-18th c. AD | (provisional) |
| Modern | 19th c. AD - present | (provisional) |
...
|---|---|
| Latin (Vulgate) parallels | (provisional) |
| Gothic (Wulfila) parallels | (provisional) |
| Old Church Slavonic (Marianus) parallels | (provisional) |
| Classical Armenian parallels | (provisional) |
